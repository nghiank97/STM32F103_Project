...
//--------------------------------------------------------------------------
const uint8_t macaddr [6] = {0x08,0x10,0x19,0x97,0x25,0x25};
const uint8_t ip [4] = {192,168,137,100};
...
{
	HAL_SPI_Transmit(&hspi1, &_byte, 1, HAL_MAX_DELAY);
}
//--------------------------------------------------
...
void ENC29J600_ini(void)
{
 ...
 else
 {
    ...
    ENC28J60_writeByte(MAMXFL,1500%256);
		ENC28J60_writeByte(MAMXFH,1500>>8);
...
{
  printf("Khoi tao module ENC28J60 that bai !\r\n");
}
