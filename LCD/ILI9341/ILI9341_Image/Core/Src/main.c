...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LCD_DB0_Pin|LCD_DB1_Pin|LCD_DB2_Pin|LCD_DB3_Pin
                          ...
                          |FLASH_CS_Pin|LCD_RST_Pin|LCD_WR_Pin|LCD_CS_Pin
                          |LCD_RS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_DB8_Pin|LCD_DB9_Pin|LCD_DB10_Pin|SPI2_CS_Pin
                          |LCD_DB11_Pin|LCD_DB12_Pin|LCD_DB13_Pin|LCD_DB14_Pin
                          |LCD_DB15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_DB8_Pin LCD_DB9_Pin LCD_DB10_Pin SPI2_CS_Pin
                           LCD_DB11_Pin LCD_DB12_Pin LCD_DB13_Pin LCD_DB14_Pin
                           LCD_DB15_Pin */
  GPIO_InitStruct.Pin = LCD_DB8_Pin|LCD_DB9_Pin|LCD_DB10_Pin|SPI2_CS_Pin
                          |LCD_DB11_Pin|LCD_DB12_Pin|LCD_DB13_Pin|LCD_DB14_Pin
                          |LCD_DB15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
